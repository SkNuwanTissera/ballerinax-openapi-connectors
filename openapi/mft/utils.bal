...
# Encoding AS2identifier
#
# + as2Identifier - unencoded as2Identifier (e.g: <333900490041112@mftgateway.com> )
# + return - Encoded string or error
isolated function encodePathParam(string as2Identifier) returns string|error {
    return check url:encode(as2Identifier, "UTF-8");
}